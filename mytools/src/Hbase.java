...
public class Hbase {
	...
	public static void getResultScann(String tableName) throws IOException {
		...
		try {
			...
			String startRow = StringUtils.connect(split, "894", "440000", "0016367", "20140319");
	...
	public static void main(String[] args) throws Exception {
		...
		String entTableName = "ENTERPRISEBASEINFOCOLLECT_20150717";
		...
		String newExtNo = "440000";
		String newPripid = "0016367";
		String[] newLstChangeDates = { "20151021", "20151022", "20151023", "20151024", "20151025" };
		String split = StringUtils.S001;
